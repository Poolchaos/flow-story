...
describe('ParticleCloud3D', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render points when data and mapping complete', async () => {
      useDataStore.getState().setParsedData(mockParsedData);
  ...
  describe('data processing', () => {
    it('should limit to 100 data points', async () => {
      ...
      // Component should handle 150 rows but only render 100
    });
  ...
  describe('optional mappings', () => {
    ...
    it('should use default size when no size mapping', async () => {
      useDataStore.getState().setParsedData(mockParsedData);
      useDataStore.getState().setColumnMapping({ x: 'x', y: 'y', z: 'z' });
